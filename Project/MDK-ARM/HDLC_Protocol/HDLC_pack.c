...
uint8_t Send_activ_energy_import[] =    {0xE6,0xE6,0x00,0xC0,0x01, 0x40,0x00,0x03,0x01,0x00, 0x01,0x08,0x00,0xFF,0x02, 0x00};
uint8_t Send_reactiv_energy_import[] =  {0xE6,0xE6,0x00,0xC0,0x01, 0x40,0x00,0x03,0x01,0x00, 0x03,0x08,0x00,0xFF,0x02, 0x00};
uint8_t Send_apparent_energy_import[] = {0xE6,0xE6,0x00,0xC0,0x01, 0x40,0x00,0x03,0x01,0x00, 0x09,0x08,0x00,0xFF,0x02, 0x00};
...
uint8_t HDLC_PackSendComand(uint8_t N,void (*uartSendDataCB)(uint8_t *data, uint16_t len))
{
  ...
  if( PosParam >= NUMBER_OF_PARAMETERS ) PosParam = 0;
/*
  if (*pack_size > len)
