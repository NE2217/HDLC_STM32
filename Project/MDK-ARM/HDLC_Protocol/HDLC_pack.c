...
*/
uint8_t request_authorize_start_LLC[] = 
{
  0xE6, 0xE6, 0x00, 0x60, 0x36, 0xA1, 0x09, 0x06, 0x07, 0x60, 0x85, 
  0x74, 0x05, 0x08, 0x01, 0x01, 0x8A, 0x02, 0x07, 0x80, 0x8B, 0x07,
  0x60, 0x85, 0x74, 0x05, 0x08, 0x02, 0x01, 0xAC, 0x0A, 0x80, 0x08 
};
uint8_t request_authorize_password_LLC[] = "12345678";
uint8_t request_authorize_end_LLC[] = 
{ 
...
uint8_t HDLC_PackSendAuthorization(void (*uartSendDataCB)(uint8_t *data, uint16_t len), uint8_t N, uint8_t password[8])
{
  ...
  memcpy(request_authorize_p.password, password, 8/*sizeof(password [8])*/);
...
//---
  ...
  uint16_t pack_size = sizeof(request_authorize_p) + CONTROL_FIELDS_SIZE;
  t_HDLC_packet p_pack;
